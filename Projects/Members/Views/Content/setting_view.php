          ...
          <form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="control-group">
              <div class="span3">
                ...
                <div class="controls">
                  <img src="<?php echo URL::base($settings->ayar_logo); ?>" alt="<?php echo $settings->ayar_title; ?>" width="150">
                </div>
              </div>
              <div class="span9">
            ...
            <div class="control-group">
              <div class="span3">
                ...
                <div class="controls">
                  <img src="<?php echo URL::base($settings->ayar_ico); ?>" alt="<?php echo $settings->ayar_title; ?>" title="<?php echo $settings->ayar_title; ?>" width="150">
                </div>
              </div>
              <div class="span9">
